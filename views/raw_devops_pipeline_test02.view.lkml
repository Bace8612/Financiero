# The name of this view in Looker is "Raw Devops Pipeline Test02"
view: raw_devops_pipeline_test02 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `finanzas_2k5e20fzcok9.RAW_DevopsPipelineTest02`
    ;;
